...
class SimaproSimaproUnitRendererTest {
    ...
    fun test_writeUnit_ShouldReturnWithoutWritingWhenAlreadyExistWithCompatibleDimension() {
        // Given
        val sut = SimaproUnitRenderer.of(mapOf("kg" to UnitValue(UnitSymbol.of("k+g"), 1.0, Prelude.mass)))
    ...
    fun test_writeUnit_ShouldDeclareUnitWhenItsTheReferenceForNewDimension() {
        // Given
        val sut = SimaproUnitRenderer.of(mapOf(Pair("kg", UnitValue(UnitSymbol.of("k+g"), 1.0, Prelude.mass))))
    ...
    fun test_writeUnit_ShouldDeclareAliasWhenItsAnAliasForExistingDimension() {
        // Given
        val sut = SimaproUnitRenderer.of(mapOf(Pair("m2", UnitValue(UnitSymbol.of("m2"), 1.0, Prelude.length.pow(2.0)))))
    ...
    fun test_writeUnit_ShouldDeclareAliasWithTheRightCase() {
        // Given
        val sut = SimaproUnitRenderer.of(mapOf(Pair("MJ", UnitValue(UnitSymbol.of("MJ"), 1.0, Prelude.length.pow(2.0)))))
    ...
    fun test_writeUnit_ShouldDeclareAliasWhenItsNotTheReference() {
        // Given
        val sut = SimaproUnitRenderer.of(mapOf(Pair("s", UnitValue(UnitSymbol.of("S"), 1.0, Prelude.mass))))
...
""".trimIndent()
    ...
    fun test_writeUnit_ShouldRecordNewUnit() {
        // Given
        val sut = SimaproUnitRenderer.of(emptyMap())
        val data = ImportedUnit("Time", "s€c", 2.0, "s")
    ...
    fun test_writeUnit_ShouldFailWithAReferenceToItselfInAnExistingDimension() {
        // Given
        val sut = SimaproUnitRenderer.of(mapOf(Pair("g", UnitValue(UnitSymbol.of("g"), 1.0, Prelude.mass))))
