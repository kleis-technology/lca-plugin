...
class EcoSpoldUnitRenderer(
    ...
    companion object {
        fun of(existingUnits: Map<String, UnitValue<BasicNumber>>): EcoSpoldUnitRenderer {
            return EcoSpoldUnitRenderer(existingUnits.toMutableMap())
        }
    }
