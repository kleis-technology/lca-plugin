...
class ModelGenerationWithDataAction(
    ...
    companion object {
        private val LOG = Logger.getInstance(ModelGenerationWithDataAction::class.java)
    }

    init {
        this.templatePresentation.setText("Generate LCA Model with ${processName}.csv", false)
    }
